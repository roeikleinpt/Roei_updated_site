        ...
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg leading-8 text-slate-600">
            {hasRealUrl
              ...
              : "תצוגה מקדימה של אזור חוות הדעת"}
          </p>
          {!hasRealUrl && (
            <p className="mx-auto mt-4 max-w-xl rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm leading-6 text-amber-900">
              הטקסטים במקטע זה זמניים ומוצגים לצורך המחשת העיצוב בלבד. הם
              יוחלפו בחוות דעת מאומתות לאחר חיבור פרופיל MedReviews.
            </p>
          )}
        </Reveal>
            ...
            <Reveal key={i} delay={i * 90}>
              <figure className="flex h-full flex-col rounded-2xl border border-slate-200 bg-white p-6">
                ...
                <figcaption className="mt-4 text-sm font-semibold text-slate-900">
                  {hasRealUrl ? t.author : "טקסט זמני לתצוגה"}
                </figcaption>
              </figure>
            </Reveal>
          ))}
