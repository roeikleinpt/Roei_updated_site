    ...
    <>
      ...
      <section id="hero" className="scroll-mt-4 pt-4 pb-16 sm:pt-6 sm:pb-24">
        <Container className="relative">
          <Reveal>
            <h1 className="mx-auto max-w-4xl text-center text-3xl font-extrabold leading-[1.2] tracking-tight text-slate-900 sm:text-4xl lg:text-5xl">
יש בעיות שמדברים עליהן בחופשיות,    {" "}            <br />
          ...
          <div className="mt-10 grid items-center gap-[22px] lg:mt-12 lg:grid-cols-2 lg:gap-[34px]">
...
<br />
            ...
            <Reveal delay={150}>
              <Image
                src={asset("/photo_for_hero.webp")}
                alt="רועי קליין, פיזיותרפיסט"
                width={716}
                height={955}
                loading="eager"
                className="mx-auto h-auto w-full max-w-[358px] rounded-[2rem] ring-1 ring-slate-200"
              />
            </Reveal>
          </div>
