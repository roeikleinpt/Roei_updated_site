    ...
    <article className="py-16 sm:py-20">
      ...
      <Container>
        <div className="mx-auto max-w-3xl">
          ...
          <p className={pClass}>
            בעבר תואר האזור הזה לרוב כאוסטאיטיס פוביס (Osteitis Pubis), מונח שעדיין נפוץ
            בימינו. הסכמת Doha בחרה שלא להמליץ עליו, לצד מונחים נוספים, בשל אי-ודאות לגבי
            הפתולוגיה שהוא מרמז עליה ובשל השוני הרב באופן שבו נעשה בו שימוש לאורך השנים.
            <Ref n={1} />
          </p>
          ...
          <ArticleCta
            intro="כאב מפשעה שחוזר באימון, בבעיטה או בשינויי כיוון, ולא ברור מה מקורו? בהערכה נבדוק מאילו מבנים הכאב מגיע, ונבנה מסלול חזרה בטוח לספורט."
            whatsappText="היי רועי, קראתי אצלך הסבר על כאב מפשעה, ואשמח לבדוק אם הטיפול מתאים לי."
          />
