      ...
      <Container>
        <div className="mx-auto max-w-3xl">
          ...
          <p className={pClass}>
            ...
            <Ref n={1} />
            <Ref n={2} />{" "}בין המצבים שיש לשקול בבירור נמצאת גם מעורבות עצבית, למשל{" "}
            <Link
            ...
            , בעיקר כאשר הכאב תלוי מאוד בישיבה, מוקל בעמידה או מלווה בתחושת שריפה ונימול.
          </p>
          <p className={pClass}>
          ...
          <p className={pClass}>
            ...
            משנת 2025 כוללות מישוש של שרירי רצפת האגן דרך פי הטבעת כאשר יש צורך להעריך כאב או
            רגישות של השרירים, מצב המכונה Pelvic Floor Myalgia&rlm;.
          ...
          <p className={pClass}>
            כאשר נמצאת Pelvic Floor Myalgia&rlm;, השרירים יכולים להיות רגישים, לפעול בטונוס מוגבר
            או להתקשות בהרפיה ובקואורדינציה.
            <Ref n={2} />
          ...
          <p className={pClass}>
            ...
            תחומי טיפול.
            <Ref n={3} />{" "}מאחר ש־CP/CPPS&rlm; אינה מחלה אחת עם גורם יחיד, גם הטיפול אינו אחיד.
          </p>
          <p className={pClass}>
            כאשר בהערכה נמצאים כאב, רגישות או תפקוד לקוי של שרירי רצפת האגן,{" "}
            <Link
            ...
            היא מרכיב מרכזי בטיפול השמרני.
            <Ref n={2} />
            <Ref n={3} />
          </p>
          <p className={pClass}>
            לצד זאת, כאשר קיימים תסמיני השתנה מסוימים ניתן לשקול טיפול תרופתי מתאים דרך הרופא,
            וכאשר קיימת מעורבות של מערכת הכאב או כאב נוירופתי ניתן לשקול אפשרויות טיפול אחרות.
            <Ref n={2} />
            <Ref n={3} />
          </p>
          <p className={pClass}>
