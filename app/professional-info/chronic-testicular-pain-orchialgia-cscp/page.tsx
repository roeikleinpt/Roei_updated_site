    ...
    <article className="py-16 sm:py-20">
      ...
      <Container>
        <div className="mx-auto max-w-3xl">
          ...
          <ArticleFigure
            src="/professional-info/chronic-scrotal-content-pain-cscp.webp"
          ...
          <p className={pClass}>
            ...
            יכול להיות קשור למשל לעצב הפודנדל, במיוחד כאשר הכאב מחמיר בישיבה ומלווה בתחושת שריפה
            או נימול.
          </p>
          <p className={pClass}>
            לקריאה נוספת:{" "}
          ...
          <p className={pClass}>
            ...
            והאגן ואת תפקוד שרירי רצפת האגן. בדיקה חיצונית או פנימית נשקלת בהתאם לצורך הקליני,
            לאחר הסבר ובהסכמת המטופל.
          </p>
          <h2 className={h2Class}>כיצד מטפלים?</h2>
          <p className={pClass}>
            פיזיותרפיה היא קו ראשון לטיפול השמרני, לאחר או לצד תהליך הבירור הרפואי. הטיפול נקבע
            בהתאם לגורמים שנמצאו בבירור ובהערכה, ועשוי לדרוש גישה רב־תחומית והתאמת ציפיות במהלך
            הטיפול.
            <Ref n={2} />
          </p>
          <p className={pClass}>
          ...
          <ArticleCta
            intro="כאשר הכאב מתמשך, לאחר שנשללו גורמים רפואיים אחרים, ובמיוחד כאשר קיימים גם תסמינים במתן שתן, ביציאות, בתפקוד המיני או באזור האגן, מוזמן ליצור קשר לבירור התאמה להערכה פיזיותרפית."
