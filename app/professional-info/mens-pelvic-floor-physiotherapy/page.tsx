...
const faqItems = [
  ...
  },
  {
    ...
    a: "לא. גם לגברים יש רצפת אגן, והיא יכולה להיות מעורבת בכאב, בבריחת שתן ובתסמיני שתן אחרים, ביציאות ובתפקוד המיני. מדובר בנושא שפחות מדובר בקרב גברים, ולכן רבים אינם יודעים שקיים מענה פיזיותרפי מותאם.",
  },
  {
