    ...
    <article className="py-16 sm:py-20">
      ...
      <Container>
        <div className="mx-auto max-w-3xl">
          ...
          <p className={pClass}>
            המונחים שין ספלינט ושין ספלינטס (Shin splints&rlm;) עדיין שגורים מאוד בקרב חיילים, רצים
            ואנשים פעילים, אך מדובר במונח ישן ולא ספציפי. הוא אינו אומר מה מקור הכאב ולכן עדיף, ככל שניתן, להגיע
            לאבחנה מדויקת יותר.
            <Ref n={1} />
            <Ref n={3} />
          </p>
