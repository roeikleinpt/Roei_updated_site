    ...
    <article className="py-16 sm:py-20">
      ...
      <Container>
        <div className="mx-auto max-w-3xl">
          ...
          <p className={pClass}>
            השם הישן אפיקונדיליטיס מדיאלי מרמז על דלקת, אך ברוב המקרים מדובר בשינויים ברקמת הגיד
            ולא בתהליך דלקתי. לכן מקובל יותר להשתמש במונחים טנדינופתיה או Medial Epicondylalgia&rlm;.
          </p>
          <p className={pClass}>
