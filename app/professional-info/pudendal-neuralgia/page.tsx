    ...
    <article className="py-16 sm:py-20">
      ...
      <Container>
        <div className="mx-auto max-w-3xl">
          ...
          <ArticleCta
            intro="אם כאב באזור האגן או איברי המין מחמיר בישיבה או מפריע לפעילות היומיומית, בדיקה פיזיותרפית יכולה לעזור להבין האם קיימים גורמים של רצפת האגן, מערכת השריר והשלד או ניהול עומסים שיכולים להיות חלק מהתמונה, ולבנות תוכנית טיפול בהתאם."
            whatsappText="היי רועי, קראתי אצלך הסבר על כאב עצב הפודנדל, ואשמח לבדוק אם הטיפול מתאים לי."
          />
