...
const faqItems = [
  {
    ...
    a: "המונח שין ספלינט הוא מונח ישן ולא ספציפי ששימש לאורך השנים לתיאור כאבים בשוק. כאשר התמונה הקלינית מתאימה לתסמונת עומס השוקה הפנימית, MTSS הוא המונח המקצועי המדויק יותר.",
  },
  {
  ...
  },
  {
    ...
    a: "אין משך זמן אחיד שמתאים לכולם. קצב החזרה תלוי במשך הזמן שבו קיימים הסימפטומים, בעומסים הנדרשים, במצב התפקודי ובתגובה להתקדמות ההדרגתית.",
  },
];
    ...
    <article className="py-16 sm:py-20">
      ...
      <Container>
        <div className="mx-auto max-w-3xl">
          ...
          <p className={pClass}>
            עם זאת, אין גורם יחיד שמסביר מדוע אדם מסוים מפתח את התסמונת. לכן בבדיקה חשוב להתייחס גם
            לעומסי האימון, לשינויים האחרונים בפעילות, ליכולת ההתאוששות ולדרישות הספציפיות של האדם.
          </p>
          ...
          <p className={pClass}>
            אין כיום טיפול יחיד שהוכח כפתרון לכל האנשים עם MTSS&rlm;. לכן הטיפול מתחיל בהבנת דפוס
            הכאב, דרישות הפעילות והעומס שהשוק נדרשת להתמודד איתו.
            <Ref n={2} />
            <Ref n={9} /> בהתאם לבדיקה, ניתן לטפל סימפטומטית ולהתאים את נפח ועצימות הפעילות, לבנות
            העמסה הדרגתית של השוק והגפה, לעבוד על כוח וסבולת ולתכנן חזרה הדרגתית לריצה, לצעידות או
            לאימון.
          </p>
          <p className={pClass}>
