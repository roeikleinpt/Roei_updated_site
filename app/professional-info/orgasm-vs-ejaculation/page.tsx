...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "החוויה התחושתית מול התהליך העצבי־שרירי, שני שלבי השפיכה, אורגזמה יבשה ושפיכה אחורית, ומה מקומם של שרירי רצפת האגן.",
...
const faqItems = [
  {
    q: "מהי אורגזמה יבשה?",
    a: "זהו תיאור למצב שבו קיימת תחושת אורגזמה אך אין פליטה נראית של נוזל זרע, או שכמותו קטנה מאוד. אחת הסיבות האפשריות היא שפיכה אחורית, שבה נוזל הזרע עובר לכיוון שלפוחית השתן במקום לצאת דרך השופכה.",
  },
  {
    q: "האם אורגזמה יבשה תמיד נובעת משפיכה אחורית?",
    a: "לא. שפיכה אחורית היא סיבה אפשרית, אך ירידה משמעותית בנפח או היעדר פליטה יכולים לנבוע גם מחסימה בצינורות השפיכה, מהשפעת תרופות או משינוי בשלב ההעברה. לכן בירור רפואי הוא שקובע מה מקור השינוי.",
  },
  {
    ...
    <article className="py-16 sm:py-20">
      ...
      <Container>
        <div className="mx-auto max-w-3xl">
          ...
          <p className={pClass}>
            מצבים כאלה יכולים להיות קשורים בין היתר לתרופות מסוימות, ניתוחים באזור הערמונית או
            צוואר השלפוחית, או לפגיעה במסלולים עצביים המעורבים בשפיכה.
            <Ref n={2} />
            <Ref n={3} />
            <Ref n={4} />
          </p>
