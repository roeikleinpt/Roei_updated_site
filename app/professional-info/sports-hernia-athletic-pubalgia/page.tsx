    ...
    <article className="py-16 sm:py-20">
      ...
      <Container>
        <div className="mx-auto max-w-3xl">
          ...
          <ArticleCta
            intro="כאב מתמשך במפשעה או בבטן התחתונה שמחמיר במאמץ ולא חולף במנוחה? בהערכה נבדוק אם מדובר בבקע ספורטאים או במקור אחר, ונבנה תוכנית חזרה הדרגתית לעומסים."
            whatsappText="היי רועי, קראתי אצלך הסבר על בקע ספורטאים, ואשמח לבדוק אם הטיפול מתאים לי."
          />
