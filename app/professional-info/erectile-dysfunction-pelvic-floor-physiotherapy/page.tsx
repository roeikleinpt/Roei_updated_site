...
const faqItems = [
  ...
  },
  {
    ...
    a: "לא. בהנחיות האירופיות תרופות ממשפחת PDE5 inhibitors נחשבות טיפול קו ראשון כאשר הן מתאימות למטופל. פיזיותרפיה של רצפת האגן יכולה להשתלב בתוכנית הטיפול כאשר ההערכה מצביעה על מרכיב שרירי מתאים.",
  },
  {
      ...
      <Container>
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-6 text-lg leading-8 text-black">
            הפרעת זקפה היא קושי מתמשך להשיג או לשמור על זקפה המספיקה לפעילות מינית. הסיבה אינה
